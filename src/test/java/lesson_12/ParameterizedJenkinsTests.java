...
@Tag("demoqa_lesson12")
public class ParameterizedJenkinsTests extends TestBase {
    ...
    void successfulPracticeFormTest() {
        ...
        step("Открываем страницу, заполняем Practice Form и жмем Submit", () ->
    ...
    void minimalPracticeFormTest() {
        ...
        step("Открываем страницу, заполняем обязательные поля Practice Form и жмем submit", () ->
                practiceFormPage.openPage()
                        .setFirstName(user.getFirstName())
                        .setLastName(user.getLastName())
                        .setGender(user.getGender())
    ...
    void negativePracticeFormTest() {
        ...
        step("Открываем страницу, заполняем не все обязательные поля Practice Form и жмем submit", () ->
                practiceFormPage.openPage()
                        .setFirstName(user.getFirstName())
                        .setEmail(user.getEmail())
                        .setUserNumber(user.getUserNumber())
